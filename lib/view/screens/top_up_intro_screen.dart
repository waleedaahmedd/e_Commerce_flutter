...
class TopUpIntroScreen extends StatefulWidget {
  // final bool wifi;
  // ChoosePackageScreen({required this.wifi});
  @override
  _TopUpIntroScreenState createState() => _TopUpIntroScreenState();
}

class _TopUpIntroScreenState extends State<TopUpIntroScreen> {
  ...
  final List _imgList = [
    ...
    'assets/images/selectService.png',
    'assets/images/quickPay.png',
  ];
                          ...
                          Column(
                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: Text(
                                  item == 'assets/images/enterNumber.png'
                                      ? "Please enter your active & valid UAE Phone number."
                                      : item == 'assets/images/selectService.png'
                                      ? "Select your Mobile / Cellular Service Provider."
                                  // : item == 'assets/images/Group 6897.png'
                                  //     ? "Insert the cash as prompted in terminal screen"
                                      : "Via Payby, you can pay through one of the following options. After the payment is successs, the number you used is topped-up with the  amount. ",
                                  style: TextStyle(
                                      fontSize: 14.sp,
                                      //letterSpacing: 0.5,
                                      height: 1.8,
                ...
                children: [
                  Padding(
                      ...
                      CustomButton(
                        ...
                        text: _current == 2 ? 'Back to Top-Up' : AppLocalizations.of(context)!.translate("proceed")!,
                      )
                    // Container(
                    //   width: double.infinity,
                    //   height: 50.h,
